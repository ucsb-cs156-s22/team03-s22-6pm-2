...
public class RecommendationController extends ApiController {
    ...
    @ApiOperation(value = "List all recommendationss")
    @PreAuthorize("hasRole('ROLE_USER')")
    @GetMapping("/all")
    public Iterable<Recommendation> allCommonss() {
        Iterable<Recommendation> commons = recommendationRepository.findAll();
        return commons;
    }
    ...
    public Recommendation updateRecommendation(
        ...
        commons.setExplanation(incoming.getExplanation());
        commons.setDateRequested(incoming.getDateRequested());
        commons.setDateNeeded(incoming.getDateNeeded());
        commons.setDone(incoming.getDone());

        recommendationRepository.save(commons);
